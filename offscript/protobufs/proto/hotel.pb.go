...
type Hotel struct {
	...
	Lattitude float32 `protobuf:"fixed32,4,opt,name=lattitude,proto3" json:"lattitude,omitempty"`
...
func (x *Hotel) GetLattitude() float32 {
	if x != nil {
		return x.Lattitude
	}
	return 0
...
func (x *Hotel) GetLongitude() float32 {
	if x != nil {
		return x.Longitude
	}
	return 0
...
var file_hotel_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x68, 0x6f, 0x74, 0x65, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x81, 0x01, 0x0a, 0x05, 0x68, 0x6f,
	...
	0x73, 0x12, 0x1c, 0x0a, 0x09, 0x6c, 0x61, 0x74, 0x74, 0x69, 0x74, 0x75, 0x64, 0x65, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x02, 0x52, 0x09, 0x6c, 0x61, 0x74, 0x74, 0x69, 0x74, 0x75, 0x64, 0x65, 0x12,
	0x1c, 0x0a, 0x09, 0x6c, 0x6f, 0x6e, 0x67, 0x69, 0x74, 0x75, 0x64, 0x65, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x02, 0x52, 0x09, 0x6c, 0x6f, 0x6e, 0x67, 0x69, 0x74, 0x75, 0x64, 0x65, 0x42, 0x09, 0x5a,
...
var file_hotel_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_hotel_proto_goTypes = []interface{}{
	(*Hotel)(nil), // 0: protoproto.hotel
}
